...
| `ANTHROPIC_BASE_URL` | Custom API endpoint. For an Anthropic-compatible gateway such as OrcaRouter, set to `https://api.orcarouter.ai/v1` and authenticate with your gateway API key |
