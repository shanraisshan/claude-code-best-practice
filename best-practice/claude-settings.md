...
| `permissions.blockReadsOutsideWorkingDirectories` | boolean | `false` | Make the file tools refuse reads outside the working directories in every permission mode. Useful when you want to prevent accidental reads of files outside your project root regardless of permission rules (v2.1.271) |
